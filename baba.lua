-- Riptzscripts UI LIB by riptidemamba, forked from H3x0R
_libVersion = "1.2"
_libChangelog = [[
    v1.1:
...
for _, gui in pairs(game:GetService("CoreGui").RobloxGui:GetChildren()) do
    if gui:IsA("ScreenGui") and string.match(gui.Name, "_RIPTZSCRIPTZ") then
        gui:Destroy()
    end
end
...
function library:CreateWindow(name, keyCode)
	...
	randomize.Name = tostring(math.random(0, 9)..math.random(0, 9)..math.random(0, 9)..math.random(0, 9)..math.random(0, 9)..math.random(0, 9)..math.random(0, 9)..math.random(0, 9)..math.random(0, 9)..math.random(0, 9)..math.random(0, 9).."_RIPTZSCRIPTZ")
...
function library:CreateNotification(title, txt)
	...
	ScreenGui.Name = tostring(math.random(0, 9)..math.random(0, 9)..math.random(0, 9)..math.random(0, 9)..math.random(0, 9)..math.random(0, 9)..math.random(0, 9)..math.random(0, 9)..math.random(0, 9)..math.random(0, 9)..math.random(0, 9).."_RIPTZSCRIPTZ")
...
function library:GetInfo()
    return _libVersion, _libChangelog
end
